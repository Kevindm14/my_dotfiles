...
vim.api.nvim_set_keymap("n", "gsd",
    "<cmd>lua require('goto-preview').goto_preview_definition()<CR>", options)
vim.api.nvim_set_keymap("n", "gsi",
    "<cmd>lua require('goto-preview').goto_preview_implementation()<CR>",
    options)
-- Only set if telescope is installed
vim.api.nvim_set_keymap("n", "gsr",
    "<cmd>lua require('goto-preview').goto_preview_references()<CR>", options)

vim.api.nvim_set_keymap("n", "gS", "<cmd>lua require('goto-preview').close_all_win()<CR>", options)
